...
A live experiment this session ([findings: memos/2026-06-15-1145](../memos/2026-06-15-1145--og-strategist--og-strategist--channels-path-a-validated-doorbell-transport-findings.body.md)) validated Claude Code **channels** as a *working* transport in this VS Code environment — and in doing so confirmed four independent reasons it can only ever be **one reference transport**, never the canonical mechanism: vendor (Anthropic-only), maturity (research preview), surface (any *flag-launched CLI session* — terminal or standalone/panel-docked window — but **not** the editor-tab extension chat; *live-corrected 2026-06-15 from the original overstated "terminal-only"* — see [memos/2026-06-15-1715](../memos/2026-06-15-1715--og-strategist--og-strategist--doorbell-surface-map-correction-and-cross-org-thingalog-validation.body.md)), and adoption friction (org-admin `channelsEnabled` gate). The vendor-neutral transports (filesystem watch, poll, MCP inbox) carry none of these.
