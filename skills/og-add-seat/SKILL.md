...
description: |
  ...
  /og-describe-org (see the current chart). Vacating or editing positions is
...
## References
- Companion: [/og-claim-seat](../og-claim-seat/SKILL.md) (staff a position) · [/og-describe-org](../og-describe-org/SKILL.md) (see the chart)
