...
- **Path B doorbell PoC** — ✅ **built + verified** 2026-06-15 ([channels/](channels/); memos/2026-06-15-1530). NEXT (authorized 2026-06-15-1600): **vendor-neutral poll transport** reusing `doorbell-core.js` unchanged, runtime-agnostic sink, no Anthropic dependency → earns the promotion (conformance #3); + **C1 operational run** (Director, personal Max account)
